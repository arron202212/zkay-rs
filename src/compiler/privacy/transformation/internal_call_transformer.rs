...
pub fn compute_transitive_circuit_io_sizes(fcts_with_verification: Vec<ConstructorOrFunctionDefinition>, cgens: BTreeMap<ConstructorOrFunctionDefinition, CircuitHelper>)
    // """
...
pub fn _compute_transitive_circuit_io_sizes(cgens: BTreeMap<ConstructorOrFunctionDefinition, CircuitHelper>, fct:ConstructorOrFunctionDefinition, gkeys:BTreeSet<((Option<MeExpr>, Option<Identifier>),CryptoParams)>, called_fcts:BTreeSet<ConstructorOrFunctionDefinition>)
   { circuit = cgens[fct];
...
pub fn transform_internal_calls(fcts_with_verification: Vec<ConstructorOrFunctionDefinition>, cgens: BTreeMap<ConstructorOrFunctionDefinition, CircuitHelper>)
    // """
