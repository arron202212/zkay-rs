...
mod tests {
    ...
    fn test_web3_gas_price() {
        ...
        assert!(!aw!(web3.gas_price()).is_empty());
        assert_eq!(&aw!(web3.gas_price()), "2000000000");
    }
    #[test]
    fn test_web3_to_checksum_address() {
        ...
        assert!(
            !aw!(web3.to_checksum_address("0x0F08283DB051c5BF85aCC4B91A257d87a0c58649")).is_empty()
        );
        assert_eq!(
            &aw!(web3.to_checksum_address("0x0F08283DB051c5BF85aCC4B91A257d87a0c58649")),
    ...
    fn test_web3_solidity_keccak() {
        ...
        assert!(!aw!(web3.solidity_keccak(b"test".into())).is_empty());
        assert_eq!(
            &aw!(web3.solidity_keccak(b"test".into())),
    ...
    fn test_web3_get_balance() {
        ...
        assert!(!aw!(web3.get_balance("0x0F08283DB051c5BF85aCC4B91A257d87a0c58649")).is_empty());
        assert_eq!(
            &aw!(web3.get_balance("0x0F08283DB051c5BF85aCC4B91A257d87a0c58649")),
    ...
    fn test_web3_eth_accounts() {
        ...
        assert!(!aw!(web3.eth_accounts()).is_empty());
        assert_eq!(
            aw!(web3.eth_accounts()),
            lc_vec_s![
                "0x0f08283db051c5bf85acc4b91a257d87a0c58649",
                "0x85372c241942d72ca13bd510d6e2b71f0f1c2959",
                "0x7b0b1a92ecd80da8f8a1340f24dfefed17dc2dbe",
                "0x195825ecaaddb2c0885d2505da2ba4383ab469fa",
                "0xb59152d3037f5d5363b5e29c6ad2cabe565136a2",
                "0xaf2c727ef24f6d5d61990e9b0e0ae65ad25b886f",
                "0x6b66e3200b1ac53e4c127048dfa0828549c95664",
                "0xbb25fc005ad3cf67064aee9bacef57952eb183c0",
                "0xcb586fc7da30c3799d02e336c1bc36ec9a9a2587",
    ...
    fn test_web3_eth_coinbase() {
        ...
        assert!(!aw!(web3.eth_coinbase()).is_empty());
        assert_eq!(
            &aw!(web3.eth_coinbase()),
    ...
    fn test_web3_get_block() {
        ...
        assert!(!aw!(web3.get_block("pending", "")).is_empty());
        println!(
            "==={:?}",
            value_or_string(aw!(web3.get_block("pending", "")))
        );
        assert_eq!(
            &aw!(web3.get_block("pending", "")),
    ...
    fn test_web3_wait_for_transaction_receipt() {
        ...
        assert!(
            !aw!(web3.wait_for_transaction_receipt(
    ...
    fn test_web3_get_code() {
        ...
        assert!(
            !aw!(web3.get_code(
                Address::from_str("0xa71526142e3105850b6b2a5dca6a110e135924e0")
                    .as_ref()
                    .unwrap()
            ))
            .is_empty()
    ...
    fn test_web3_estimate_gas() {
        ...
        assert_eq!(
            &aw!(web3.estimate_gas("0xa71526142e3105850b6b2a5dca6a110e135924e0", "", vec![])),
            "0"
        );
    }
}
