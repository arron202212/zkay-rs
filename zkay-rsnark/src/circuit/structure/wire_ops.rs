...
//     fn neg(self,  desc: &String) -> WireType;
// }

// pub trait Or<T=Self>{
//      fn or(self, w: T, desc: &String) -> WireType ;
// }

// pub trait Xor<T=Self>{
//      fn xor(self, w: T, desc: &String) -> WireType ;
// }

// pub trait And<T=Self>{
//      fn and(self, w: T, desc: &String) -> WireType ;
// }

pub trait XorBitwise<T = Self> {
    fn xor_bitwise(self, w: T, numBits: i32, desc: &String) -> WireType;
}

pub trait AndBitwise<T = Self> {
    fn and_bitwise(self, w: T, numBits: i32, desc: &String) -> WireType;
}

pub trait OrBitwise<T = Self> {
    fn or_bitwise(self, w: T, numBits: i32, desc: &String) -> WireType;
}

pub trait IsEqualTo<T = Self> {
    fn is_equal_to(&self, w: T, desc: &String) -> WireType;
}

pub trait IsLessThanOrEqual<T = Self> {
    fn is_less_than_or_equal(&self, w: T, bitwidth: i32, desc: &String) -> WireType;
}
pub trait IsLessThan<T = Self> {
    fn is_less_than(&self, w: T, bitwidth: i32, desc: &String) -> WireType;
}
pub trait IsGreaterThanOrEqual<T = Self> {
    fn is_greater_than_or_equal(&self, w: T, bitwidth: i32, desc: &String) -> WireType;
}
pub trait IsGreaterThan<T = Self> {
    fn is_greater_than(&self, w: T, bitwidth: i32, desc: &String) -> WireType;
}
