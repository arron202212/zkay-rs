...
impl    ZkayECDHGadget{
    pub  fn new(hX:Wire , secretKey:Wire , validateSecret:bool , desc:Vec<String>)->Self {
        super(desc);
...
impl   ZkayEcGadget  for ZkayECDHGadget{
    ...
    pub  fn getOutputWires()->  Vec<Wire> {
        let sharedKey = ZkaySHA256Gadget::new(vec![Wire::default();]{sharedSecret}, 128).getOutputWires()[0];
        return vec![Wire::default();] { sharedKey };
    }
