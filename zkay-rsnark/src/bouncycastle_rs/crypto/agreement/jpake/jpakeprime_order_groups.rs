...
// 假設上一節定義的結構體在這裡
// use crate::jpake::JpakePrimeOrderGroup;

pub struct JpakePrimeOrderGroups;

impl JpakePrimeOrderGroups {
    /// 輔助函數：從 16 進制字符串解析 BigInt
    fn parse_hex(hex: &str) -> BigInt {
        BigInt::parse_bytes(hex.as_bytes(), 16)
            .expect("J-PAKE 靜態參數解析失敗，請檢查 16 進制格式")
    }

    /// SUN JCE 1024-bit 群
    pub fn sun_jce_1024() -> &'static JpakePrimeOrderGroup {
        static INSTANCE: OnceLock<JpakePrimeOrderGroup> = OnceLock::new();
        INSTANCE.get_or_init(|| {
            let p = Self::parse_hex("fd7f53811d75122952df4a9c2eece4e7f611b7523cef4400c31e3f80b6512669\
                                     455d402251fb593d8d58fabfc5f5ba30f6cb9b556cd7813b801d346ff26660b7\
                                     6b9950a5a49f9fe8047b1022c24fbba9d7feb7c61bf83b57e7c6a8a6150f04fb\
                                     83f6d3c51ec3023554135a169132f675f3ae2b61d72aeff22203199dd14801c7");
            let q = Self::parse_hex("9760508f15230bccb292b982a2eb840bf0581cf5");
            let g = Self::parse_hex("f7e1a085d69b3ddecbbcab5c36b857b97994afbbfa3aea82f9574c0b3d078267\
                                     5159578ebad4594fe67107108180b449167123e84c281613b7cf09328cc8a6e1\
                                     3c167a8b547c8d28e0a3ae1e2bb3a675916ea37f0bfa213562f1fb627a01243b\
                                     cca4f1bea8519089a883dfe15ae59f06928b665e807b552564014c3bfecf492a");
            
            JpakePrimeOrderGroup::new_internal(p, q, g, true).unwrap()
        })
    }

    /// NIST 2048-bit 群
    pub fn nist_2048() -> &'static JpakePrimeOrderGroup {
        static INSTANCE: OnceLock<JpakePrimeOrderGroup> = OnceLock::new();
        INSTANCE.get_or_init(|| {
            let p = Self::parse_hex("C196BA05AC29E1F9C3C72D56DFFC6154A033F1477AC88EC37F09BE6C5BB95F51\
                                     C296DD20D1A28A067CCC4D4316A4BD1DCA55ED1066D438C35AEBAABF57E7DAE4\
                                     28782A95ECA1C143DB701FD48533A3C18F0FE23557EA7AE619ECACC7E0B51652\
                                     A8776D02A425567DED36EABD90CA33A1E8D988F0BBB92D02D1D20290113BB562\
                                     CE1FC856EEB7CDD92D33EEA6F410859B179E7E789A8F75F645FAE2E136D252BF\
            ...
            let q = Self::parse_hex("90EAF4D1AF0708B1B612FF35E0A2997EB9E9D263C9CE659528945C0D");
            let g = Self::parse_hex("A59A749A11242C58C894E9E5A91804E8FA0AC64B56288F8D47D51B1EDC4D6544\
                                     4FECA0111D78F35FC9FDD4CB1F1B79A3BA9CBEE83A3F811012503C8117F98E50\
                                     48B089E387AF6949BF8784EBD9EF45876F2E6A5A495BE64B6E770409494B7FEE\
                                     1DBB1E4B2BC2A53D4F893D418B7159592E4FFFDF6969E91D770DAEBD0B5CB14C\
                                     00AD68EC7DC1E5745EA55C706C4A1C5C88964E34D09DEB753AD418C1AD0F4FDF\
    ...
    /// NIST 3072-bit 群（J-PAKE 默認建議）
    pub fn nist_3072() -> &'static JpakePrimeOrderGroup {
        static INSTANCE: OnceLock<JpakePrimeOrderGroup> = OnceLock::new();
        INSTANCE.get_or_init(|| {
            // ... 同上邏輯，省略冗長的 NIST_3072 十六進制字符串 ...
            let p = Self::parse_hex("90066455B5CFC38F9CAA4A48B4281F29...");
            let q = Self::parse_hex("CFA0478A54717B08CE64805B76E5B142...");
            let g = Self::parse_hex("5E5CBA992E0A680D885EB903AEA78E4A...");
            JpakePrimeOrderGroup::new_internal(p, q, g, true).unwrap()
        })
    }
}
