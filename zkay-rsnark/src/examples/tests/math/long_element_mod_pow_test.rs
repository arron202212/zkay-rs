...
mod test {
    ...
    pub fn test_zero_base() {
        let mut generator = ModPowCircuitGenerator::new(
            "ModPow testZeroBase",
            BigInteger::ZERO,
            BigInteger::from(123),
            BigInteger::from(456),
    ...
    pub fn test_medium_numbers() {
        let mut generator = ModPowCircuitGenerator::new(
            "ModPow testMediumNumbers",
            BigInteger::from(1298864277),
