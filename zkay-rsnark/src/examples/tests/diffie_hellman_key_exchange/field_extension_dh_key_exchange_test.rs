...
use crate::examples::gadgets::diffie_hellman_key_exchange::field_extension_dh_key_exchange;
...
mod test {
    ...
    pub fn testHardcodedKeys() {
        let generator = CircuitGenerator::new("FieldExtension_Test1");
        ...
        impl CGConfig for CircuitGeneratorExtend<CGTest> {
            fn buildCircuit(&mut self) {
                ...
                let fieldExtensionDHKeyExchange =
                    FieldExtensionDHKeyExchange::new(g, h, exponentBits, omega, "");
    ...
    pub fn testVariableKeys() {
        let generator = CircuitGenerator::new("FieldExtension_Test2");
    ...
    pub fn testInputValidation() {
        let generator = CircuitGenerator::new("FieldExtension_Test3");
