...
const edwards_r_limbs:mp_size_t = (edwards_r_bitcount+GMP_NUMB_BITS-1)/GMP_NUMB_BITS;
const edwards_q_limbs:mp_size_t = (edwards_q_bitcount+GMP_NUMB_BITS-1)/GMP_NUMB_BITS;

// extern bigint<edwards_r_limbs> edwards_modulus_r;
// extern bigint<edwards_q_limbs> edwards_modulus_q;

type edwards_Fr=Fp_model<edwards_r_limbs, edwards_modulus_r>;
type edwards_Fq=Fp_model<edwards_q_limbs, edwards_modulus_q>;
type edwards_Fq3=Fp3_model<edwards_q_limbs, edwards_modulus_q>;
type edwards_Fq6=Fp6_2over3_model<edwards_q_limbs, edwards_modulus_q>;
type edwards_GT=edwards_Fq6;
