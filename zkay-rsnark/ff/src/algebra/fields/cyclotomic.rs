...
pub trait CyclotomicMultSubgroup: Field {
    ...
    /// Compute a square in the cyclotomic subgroup. By default this is computed using [`Field::square`](Field::square), but for
    ...
    /// [`Field::square_in_place`](Field::square_in_place), but for degree 12 extensions,
