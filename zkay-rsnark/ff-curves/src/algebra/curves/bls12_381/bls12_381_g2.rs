...
pub fn print() const
{
    ...
    else
    {
        ...
        print!("(%Nd*z + %Nd , %Nd*z + %Nd)\n",
                   copy.X.c1.as_bigint().0.0, bls12_381_Fq::num_limbs,
                   copy.X.c0.as_bigint().0.0, bls12_381_Fq::num_limbs,
                   copy.Y.c1.as_bigint().0.0, bls12_381_Fq::num_limbs,
                   copy.Y.c0.as_bigint().0.0, bls12_381_Fq::num_limbs);
    }
}
...
pub fn print_coordinates() const
{
    ...
    else
    {
        print!("(%Nd*z + %Nd : %Nd*z + %Nd : %Nd*z + %Nd)\n",
                   this->X.c1.as_bigint().0.0, bls12_381_Fq::num_limbs,
                   this->X.c0.as_bigint().0.0, bls12_381_Fq::num_limbs,
                   this->Y.c1.as_bigint().0.0, bls12_381_Fq::num_limbs,
                   this->Y.c0.as_bigint().0.0, bls12_381_Fq::num_limbs,
                   this->Z.c1.as_bigint().0.0, bls12_381_Fq::num_limbs,
                   this->Z.c0.as_bigint().0.0, bls12_381_Fq::num_limbs);
    }
}
