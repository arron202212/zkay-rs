...
use ffec::algebra::fields::{Zero,field::{AdditiveGroup, Field}, fpn_field::PrimeField, prime_base::MontFp};
use ffec::algebra::field_utils::{BigInt};
 use crate::algebra::curves::bls12_381::{Fq2,Fr};
...
impl SWCurveConfig for Config {
    ...
    fn is_in_correct_subgroup_assuming_on_curve(point: &G2Affine) -> bool {
        ...
        let mut x_times_point = point.mul_bigint(super::Config::X);
        if super::Config::X_IS_NEGATIVE {
    ...
    fn clear_cofactor(p: &G2Affine) -> G2Affine {
        ...
        // weight.
        let x: &'static [u64] = super::Config::X;
