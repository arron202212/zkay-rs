...
use crate::algebra::curves::bls12_381::{Fq, Fq2, Fr, g2};
...
mod test {
    ...
    #[test]
    fn test_gen() {
        let r#gen: G2Affine = curves::g2_swu_iso::SwuIsoConfig::GENERATOR;
        assert!(r#gen.is_on_curve());
        assert!(r#gen.is_in_correct_subgroup_assuming_on_curve());
    }
}
