use crate::algebra::curves::alt_bn128::alt_bn128_fields::{
    alt_bn128_Fq, alt_bn128_Fq2, alt_bn128_Fq12, alt_bn128_GT,alt_bn128_Fr
};
use crate::algebra::curves::alt_bn128::alt_bn128_g1::alt_bn128_G1;
use crate::algebra::curves::alt_bn128::alt_bn128_g2::alt_bn128_G2;
 use crate::algebra::curves::alt_bn128::alt_bn128_init::{alt_bn128_twist,alt_bn128_ate_is_loop_count_neg,alt_bn128_ate_loop_count,alt_bn128_twist_coeff_b,alt_bn128_final_exponent_z,alt_bn128_final_exponent_is_z_neg};
use ffec::PpConfig;
...
pub fn alt_bn128_ate_miller_loop(
    ...
    for i in ( 0..=loop_count.max_bits() as usize).rev()
    {
        ...
        /* code below gets executed for all bits (EXCEPT the MSB itself) of
           ...
           order */
        c = prec_Q.coeffs[idx].clone();idx+=1;
        f = f.squared();
...
pub fn alt_bn128_ate_double_miller_loop(
    ...
    for i in ( 0..=loop_count.max_bits()).rev()
    {
        ...
        f = f.mul_by_024(&c1.ell_0, &(&c1.ell_VW*&prec_P1.PY), &(&c1.ell_VV*&prec_P1.PX));
        f = f.mul_by_024(&c2.ell_0, &(&c2.ell_VW*&prec_P2.PY), &(&c2.ell_VV*&prec_P2.PX));
