...
impl PublicParams for bn128_pp {
    ...
    fn miller_loop(prec_P: &Self::G1_precomp, prec_Q: &Self::G2_precomp) -> Self::Fqk {
        let span = span!(Level::INFO, "Call to miller_loop<bn128_pp>").entered();
    ...
    fn double_miller_loop(
        ...
        let span = span!(Level::INFO, "Call to double_miller_loop<bn128_pp>").entered();
    ...
    fn pairing(P: &Self::G1, Q: &Self::G2) -> Self::Fqk {
        let span = span!(Level::INFO, "Call to pairing<bn128_pp>").entered();
    ...
    fn reduced_pairing(P: &Self::G1, Q: &Self::G2) -> Self::GT {
        let span = span!(Level::INFO, "Call to reduced_pairing<bn128_pp>").entered();
