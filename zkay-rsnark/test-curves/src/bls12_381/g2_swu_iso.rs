use crate::bls12_381::{Fq, Fq2, Fr, g2};
use ark_ec::models::{
    CurveConfig,
...
mod test {
    ...
    #[test]
    fn test_gen() {
        let gens: G2Affine = g2_swu_iso::SwuIsoConfig::GENERATOR;
        assert!(gens.is_on_curve());
        assert!(gens.is_in_correct_subgroup_assuming_on_curve());
    }
}
