...
// bool process_arithm_command_line(argc:int, argv:char**,
//                                  String &assembly_fn,
...
//     type default_ram=ram_tinyram<FieldT>;
...
//     boot_trace_size_bound:ram_boot_trace<default_ram> boot_trace = tinyram_boot_trace_from_program_and_input(ap,, program, primary_input);
