    ...
    pub fn new(pb: ProtoboardPtr, input: VariableArrayType, result: Variable) -> Gadget<Self> {
        ...
        Gadget::<Self>::new(
            ...
            Self {
                ...
                sumInverse_: Variable::from("sumInverse"),
            },
        )
    }
}
...
impl R1P_EqualsConst_Gadget {
    pub fn new(
        ...
        Gadget::<Self>::new(
            ...
            Self {
                n_: n,
                aux_: Variable::from("aux :R1P_EqualsConst_Gadget"),
                input_: input,
                result_: result,
            },
        )
    ...
    pub fn new(
        ...
        Gadget::<Self>::new(
            ...
            Self {
                ...
                auxConditionInverse_: Variable::from(
    ...
    pub fn new(
        ...
        Gadget::<Self>::new(
            ...
            Self {
                ...
                alpha_u_: UnpackedWord::new(wordBitSize, "alpha".to_owned()),
                notAllZeroes_: FlagVariable::from("notAllZeroes"),
