...
pub type r1cs_mp_ppzkpcd_message<PCD_ppT> = r1cs_pcd_message<
    Fr<<PCD_ppT as PcdPptConfig>::curve_A_pp>,
    <<PCD_ppT as PcdPptConfig>::curve_A_pp as ppTConfig>::M,
>;
...
pub type r1cs_mp_ppzkpcd_primary_input<PCD_ppT> = r1cs_pcd_compliance_predicate_primary_input<
    Fr<<PCD_ppT as PcdPptConfig>::curve_A_pp>,
    <<PCD_ppT as PcdPptConfig>::curve_A_pp as ppTConfig>::M,
>;

pub type r1cs_mp_ppzkpcd_auxiliary_input<PCD_ppT> = r1cs_pcd_compliance_predicate_auxiliary_input<
    Fr<<PCD_ppT as PcdPptConfig>::curve_A_pp>,
    <<PCD_ppT as PcdPptConfig>::curve_A_pp as ppTConfig>::M,
    <<PCD_ppT as PcdPptConfig>::curve_A_pp as ppTConfig>::LD,
>;
