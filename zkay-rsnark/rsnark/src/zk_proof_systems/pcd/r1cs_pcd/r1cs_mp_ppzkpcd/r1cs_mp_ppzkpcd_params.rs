...
pub type r1cs_mp_ppzkpcd_message<PCD_ppT> = r1cs_pcd_message<Fr<<PCD_ppT as PcdConfigPptConfig>::curve_A_pp>,<PCD_ppT as ppTConfig>::M>;

pub type r1cs_mp_ppzkpcd_local_data<PCD_ppT> = r1cs_pcd_local_data<Fr<<PCD_ppT as PcdConfigPptConfig>::curve_A_pp>,<PCD_ppT as ppTConfig>::LD>>;

pub type r1cs_mp_ppzkpcd_primary_input<PCD_ppT> =
    r1cs_pcd_compliance_predicate_primary_input<Fr<<PCD_ppT as PcdConfigPptConfig>::curve_A_pp>,<PCD_ppT as ppTConfig>::M>;

pub type r1cs_mp_ppzkpcd_auxiliary_input<PCD_ppT> =
    r1cs_pcd_compliance_predicate_auxiliary_input< Fr<<PCD_ppT as PcdConfigPptConfig>::curve_A_pp>,
    <PCD_ppT as ppTConfig>::M,
