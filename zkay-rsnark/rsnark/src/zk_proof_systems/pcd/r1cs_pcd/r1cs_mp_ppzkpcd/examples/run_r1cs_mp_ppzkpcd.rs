...
//
pub fn run_r1cs_mp_ppzkpcd_tally_example<PCD_ppT>(
    wordsize: usize,
    max_arity: usize,
    depth: usize,
    test_serialization: bool,
    ...
    let mut tally_1 = tally_cp_handler::<FieldT>::new(
        1,
        max_arity,
        wordsize,
    ...
    let mut tally_2 = tally_cp_handler::<FieldT>::new(
        2,
        max_arity,
        wordsize,
        test_same_type_optimization,
    ...
    for layer in (0..=depth).rev() {
        for i in 0..nodes_in_layer {
            ...
            let cur_tally = if tree_types[cur_idx] == 1 {
                tally_1
            } else {
                tally_2
            };
            ...
            let tally_auxiliary_input =
                r1cs_pcd_compliance_predicate_auxiliary_input::<FieldT>::new(
                    msgs,
                    ld,
                    cur_tally.get_witness(),
                );
            ...
            let pcd_verifier_input =
                r1cs_mp_ppzkpcd_primary_input::<PCD_ppT>(tree_messages[cur_idx]);
