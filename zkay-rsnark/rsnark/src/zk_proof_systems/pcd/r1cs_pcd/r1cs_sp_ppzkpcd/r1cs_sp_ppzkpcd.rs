...
impl r1cs_sp_ppzkpcd_keypair<PCD_ppT> {
    ...
    pub fn new2(kp_A: r1cs_ppzksnark_keypair<A_pp>, kp_B: r1cs_ppzksnark_keypair<B_pp>) -> Self {
        Self {
...
pub fn r1cs_sp_ppzkpcd_generator<PCD_ppT>(
    compliance_predicate: r1cs_sp_ppzkpcd_compliance_predicate<PCD_ppT>,
    ...
    let mut compliance_step_pcd_circuit =
        sp_compliance_step_pcd_circuit_maker::<curve_A_pp>::new(compliance_predicate);
    ...
    let mut translation_step_pcd_circuit =
        sp_translation_step_pcd_circuit_maker::<curve_B_pp>(compliance_step_keypair.vk);
...
pub fn r1cs_sp_ppzkpcd_prover<PCD_ppT>(
    pk: r1cs_sp_ppzkpcd_proving_key<PCD_ppT>,
    primary_input: r1cs_sp_ppzkpcd_primary_input<PCD_ppT>,
    auxiliary_input: r1cs_sp_ppzkpcd_auxiliary_input<PCD_ppT>,
    incoming_proofs: Vec<r1cs_sp_ppzkpcd_proof<PCD_ppT>>,
    ...
    let mut compliance_step_pcd_circuit =
        sp_compliance_step_pcd_circuit_maker::<curve_A_pp>::new(pk.compliance_predicate);
    ...
    // #ifdef DEBUG
    let compliance_step_input = get_sp_compliance_step_pcd_circuit_input::<curve_A_pp>(
        translation_step_r1cs_vk_bits,
        primary_input,
    );
    ...
    let translation_step_pcd_circuit =
        sp_translation_step_pcd_circuit_maker::<curve_B_pp>(pk.compliance_step_r1cs_vk);

    let translation_step_primary_input = get_sp_translation_step_pcd_circuit_input::<curve_B_pp>(
        translation_step_r1cs_vk_bits,
        primary_input,
    );
...
pub fn r1cs_sp_ppzkpcd_online_verifier<PCD_ppT>(
    ...
    let r1cs_input = get_sp_translation_step_pcd_circuit_input::<curve_B_pp>(
...
pub fn r1cs_sp_ppzkpcd_process_vk<PCD_ppT>(
    vk: r1cs_sp_ppzkpcd_verification_key<PCD_ppT>,
...
pub fn r1cs_sp_ppzkpcd_verifier<PCD_ppT>(
    vk: r1cs_sp_ppzkpcd_verification_key<PCD_ppT>,
    primary_input: r1cs_sp_ppzkpcd_primary_input<PCD_ppT>,
    proof: r1cs_sp_ppzkpcd_proof<PCD_ppT>,
) -> bool {
