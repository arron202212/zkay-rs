...
//
pub fn run_r1cs_sp_ppzkpcd_tally_example<PCD_ppT>(
    wordsize: usize,
    arity: usize,
    depth: usize,
    test_serialization: bool,
    ...
    for layer in (0..=depth).rev() {
        for i in 0..nodes_in_layer {
            ...
            let proof = r1cs_sp_ppzkpcd_prover::<PCD_ppT>(
                keypair.pk,
                tally_primary_input,
            ...
            let pcd_verifier_input =
                r1cs_sp_ppzkpcd_primary_input::<PCD_ppT>::new(tree_messages[cur_idx]);
