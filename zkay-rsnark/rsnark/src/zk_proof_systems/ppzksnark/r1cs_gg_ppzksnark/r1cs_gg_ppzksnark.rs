...
pub fn r1cs_gg_ppzksnark_generator<
    ppT: PptConfig,
    const NN: usize,
    FieldT: FieldTConfig,
...
pub fn r1cs_gg_ppzksnark_prover<
    ppT: PptConfig,
    const NN: usize,
    FieldT: FieldTConfig,
    ED: evaluation_domain<FieldT>,
...
pub fn r1cs_gg_ppzksnark_verifier_weak_IC<
    ppT: PptConfig,
    const NN: usize,
    FieldT: FieldTConfig,
    ED: evaluation_domain<FieldT>,
...
pub fn r1cs_gg_ppzksnark_verifier_strong_IC<
    ppT: PptConfig,
    const NN: usize,
    FieldT: FieldTConfig,
    ED: evaluation_domain<FieldT>,
...
pub fn r1cs_gg_ppzksnark_verifier_process_vk<
    ppT: PptConfig,
    const NN: usize,
    FieldT: FieldTConfig,
    ED: evaluation_domain<FieldT>,
...
pub fn r1cs_gg_ppzksnark_online_verifier_weak_IC<
    ppT: PptConfig,
    const NN: usize,
    FieldT: FieldTConfig,
    ED: evaluation_domain<FieldT>,
...
pub fn r1cs_gg_ppzksnark_online_verifier_strong_IC<
    ppT: PptConfig,
    const NN: usize,
    FieldT: FieldTConfig,
    ED: evaluation_domain<FieldT>,
...
pub fn r1cs_gg_ppzksnark_affine_verifier_weak_IC<
    ppT: PptConfig,
    const NN: usize,
    FieldT: FieldTConfig,
    ED: evaluation_domain<FieldT>,
