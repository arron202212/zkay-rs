...
fn main( argc:i32, argv:&[&str])->i32
{
    ...
    r1cs_example<ffec::Fr<default_r1cs_ppzksnark_pp> > example = generate_r1cs_example_with_field_input<ffec::Fr<default_r1cs_ppzksnark_pp> >(num_constraints, input_size);
