...
//
pub fn sigSign<default_r1cs_ppzkadsnark_pp>(
    sk: &ed25519_skT,
    label: &labelT,
...
//
pub fn sigVerif<default_r1cs_ppzkadsnark_pp>(
    vk: &ed25519_vkT,
    label: &labelT,
    Lambda: &ffec::G2<snark_pp<default_r1cs_ppzkadsnark_pp>>,
    sig: &ed25519_sigT,
    ...
    let res = crypto_sign_ed25519_amd64_51_30k_open(
        message,
        &msglen,
        signature,
        64 + 16 + 320,
...
//
pub fn sigBatchVerif<default_r1cs_ppzkadsnark_pp>(
    vk: &ed25519_vkT,
    labels: &Vec<labelT>,
    Lambdas: &Vec<ffec::G2<snark_pp<default_r1cs_ppzkadsnark_pp>>>,
    sigs: &Vec<ed25519_sigT>,
) -> bool {
    let mut stream = String::new();
