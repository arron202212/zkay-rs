 ...
 */
//
pub fn run_r1cs_ppzkadsnark<ppT>(
    example: r1cs_example<Fr<snark_pp<ppT>>>,
    test_serialization: bool,
) -> bool {
    ...
    let auth_resp = r1cs_ppzkadsnark_auth_verify::<ppT>(data, auth_data, auth_keys.pak, labels);
