...
impl Fp3_variable<Fp3T> {
    ...
    pub fn new2(pb: &RcCell<protoboard<FieldT>>, el: &Fp3T, annotation_prefix: &String) -> Self {
        c0.assign(&pb, el.c0);
        c1.assign(&pb, el.c1);
        c2.assign(&pb, el.c2);
    ...
    pub fn generate_r1cs_equals_const_constraints(el: &Fp3T) {
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(1, el.c0, c0),
            FMT(self.annotation_prefix, " c0"),
        );
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(1, el.c1, c1),
            FMT(self.annotation_prefix, " c1"),
        );
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(1, el.c2, c2),
    ...
    pub fn mul_by_X() -> Fp3_variable<Fp3T> {
        ...
        return Fp3_variable::<Fp3T>(
            ...
            new_c1,
            new_c2,
            FMT(self.annotation_prefix, " mul_by_X"),
        );
    }
        ...
        */
        ...
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(
                ...
                result.c1
                    + result.c2
                    + result.c0 * beta.inverse()
                    + v0 * (FieldT(1) - beta.inverse())
                    + v4 * (FieldT(1) - beta),
            ),
...
impl Fp3_sqr_gadget<Fp3T> {
    pub fn new(
        ...
        mul = RcCell::new(Fp3_mul_gadget::<Fp3T>::new(
            pb,
            A,
            A,
            result,
