...
pub struct mnt4_final_exp_gadget<ppT: ppTConfig<FieldT, PB>, FieldT: FieldTConfig, PB: PBConfig> {
    //gadget<Fr<ppT> >
    el: Fqk_variable<ppT, FieldT, PB>,
    one: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_inv: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_q_3: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_q_3_minus_1: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    alpha: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    beta: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    beta_q: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_inv_q_3: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_inv_q_3_minus_1: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    inv_alpha: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    inv_beta: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    w1: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    w0: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    result: RcCell<Fqk_variable<ppT, FieldT, PB>>,

    compute_el_inv: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,
    compute_el_q_3_minus_1: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,
    compute_beta: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,
    compute_el_inv_q_3_minus_1: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,
    compute_inv_beta: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,

    compute_w1: RcCell<exponentiation_gadgets<ppT, FieldT, PB>>,
    compute_w0: RcCell<exponentiation_gadgets<ppT, FieldT, PB>>,
    compute_result: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,

    result_is_one: variable<FieldT, pb_variable>,
}
 ...
 */
#[derive(Clone, Default)]
pub struct mnt6_final_exp_gadget<ppT: ppTConfig<FieldT, PB>, FieldT: FieldTConfig, PB: PBConfig> {
    //gadget<Fr<ppT> >
    ...
    one: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_inv: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_q_2: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_q_2_minus_1: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_q_3_minus_q: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_inv_q_2: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    el_inv_q_2_minus_1: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    w1: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    w0: RcCell<Fqk_variable<ppT, FieldT, PB>>,
    result: RcCell<Fqk_variable<ppT, FieldT, PB>>,

    compute_el_inv: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,
    compute_el_q_2_minus_1: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,
    compute_el_inv_q_2_minus_1: RcCell<Fqk_mul_gadget<ppT, FieldT, PB>>,
...
pub type mnt4_final_exp_gadgets<ppT, FieldT, PB> =
    gadget<FieldT, PB, mnt4_final_exp_gadget<ppT, FieldT, PB>>;

impl<ppT: ppTConfig<FieldT, PB>, FieldT: FieldTConfig, PB: PBConfig>
    mnt4_final_exp_gadget<ppT, FieldT, PB>
{
    pub fn new(
    ...
    ) -> mnt4_final_exp_gadgets<ppT, FieldT, PB> {
        let one = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " one"),
        ));
        let el_inv = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " el_inv"),
        ));
        let el_q_3 = RcCell::new(el.Frobenius_map(3));
        let el_q_3_minus_1 = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " el_q_3_minus_1"),
        ));
        let alpha = RcCell::new(el_q_3_minus_1.borrow().Frobenius_map(1));
        let beta = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
        ...
        let el_inv_q_3_minus_1 = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " el_inv_q_3_minus_1"),
        ));
        let inv_alpha = RcCell::new(el_inv_q_3_minus_1.borrow().Frobenius_map(1));
        let inv_beta = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " inv_beta"),
        ));
        let w1 = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " w1"),
        ));
        let w0 = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " w0"),
        ));
        let result = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " result"),
        ));

        let compute_el_inv = RcCell::new(Fqk_mul_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
            el.clone(),
            el_inv.borrow().clone(),
            one.borrow().clone(),
        ...
        let compute_el_q_3_minus_1 = RcCell::new(Fqk_mul_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
            el_q_3.borrow().clone(),
            el_inv.borrow().clone(),
        ...
        let compute_beta = RcCell::new(Fqk_mul_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
            alpha.borrow().clone(),
            el_q_3_minus_1.borrow().clone(),
            beta.borrow().clone(),
        ...
        let compute_el_inv_q_3_minus_1 = RcCell::new(Fqk_mul_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
        ...
        let compute_inv_beta = RcCell::new(Fqk_mul_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
        ...
        let compute_w1 = RcCell::new(exponentiation_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
            beta_q.borrow().clone(),
        ...
        let compute_w0 = RcCell::new(exponentiation_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
        ...
        let compute_result = RcCell::new(Fqk_mul_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
            w1.borrow().clone(),
            w0.borrow().clone(),
            result.borrow().clone(),
    ...
    mnt4_final_exp_gadgets<ppT, FieldT, PB>
{
    ...
    pub fn generate_r1cs_witness(&self) {
        self.t.one.borrow().generate_r1cs_witness(&FieldT::one());
        self.t
            .el_inv
            .borrow()
            .generate_r1cs_witness(&self.t.el.get_element().inverse().to_field());
...
pub type mnt6_final_exp_gadgets<ppT, FieldT, PB> =
    gadget<FieldT, PB, mnt6_final_exp_gadget<ppT, FieldT, PB>>;
impl<ppT: ppTConfig<FieldT, PB>, FieldT: FieldTConfig, PB: PBConfig>
    mnt6_final_exp_gadget<ppT, FieldT, PB>
{
    pub fn new(
        pb: RcCell<protoboard<FieldT, PB>>,
        el: Fqk_variable<ppT, FieldT, PB>,
        result_is_one: variable<FieldT, pb_variable>,
        annotation_prefix: String,
    ) -> mnt6_final_exp_gadgets<ppT, FieldT, PB> {
        let one = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
            prefix_format!(annotation_prefix, " one"),
        ));
        ...
        let el_q_2_minus_1 = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
        ...
        let el_inv_q_2_minus_1 = RcCell::new(Fqk_variable::<ppT, FieldT, PB>::new(
            pb.clone(),
        ...
        let compute_el_q_2_minus_1 = RcCell::new(Fqk_mul_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
            el_q_2.borrow().clone(),
            el_inv.borrow().clone(),
        ...
        let compute_el_inv_q_2_minus_1 = RcCell::new(Fqk_mul_gadget::<ppT, FieldT, PB>::new(
            pb.clone(),
