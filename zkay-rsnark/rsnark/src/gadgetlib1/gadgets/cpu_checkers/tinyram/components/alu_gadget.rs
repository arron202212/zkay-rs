...
impl ALU_gadget {
    pub fn new(
        ...
        /* arithmetic */
        components[tinyram_opcode_AND]=RcCell::new(ALU_and_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_OR]=RcCell::new(ALU_or_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_XOR]=RcCell::new(ALU_xor_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_NOT]=RcCell::new(ALU_not_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_ADD]=RcCell::new(ALU_add_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_SUB]=RcCell::new(ALU_sub_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_MOV]=RcCell::new(ALU_mov_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_CMOV]=RcCell::new(ALU_cmov_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_CMPA]=RcCell::new(ALU_cmp_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_CMPG]=RcCell::new(ALU_cmps_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_UMULH]=RcCell::new(ALU_umul_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_SMULH]=RcCell::new(ALU_smul_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_UDIV]=RcCell::new(ALU_divmod_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        components[tinyram_opcode_SHR]=RcCell::new(ALU_shr_shl_gadget::<FieldT>::new(
            pb,
            opcode_indicators,
            desval,
            arg1val,
        ...
        /* control flow */
        components[tinyram_opcode_JMP]=RcCell::new(ALU_jmp_gadget::<FieldT>::new(
            pb,
            pc,
            arg2val,
            flag,
        ...
        components[tinyram_opcode_CJMP]=RcCell::new(ALU_cjmp_gadget::<FieldT>::new(
            pb,
            pc,
            arg2val,
            flag,
        ...
        components[tinyram_opcode_CNJMP]=RcCell::new(ALU_cnjmp_gadget::<FieldT>::new(
            pb,
            pc,
            arg2val,
            flag,
