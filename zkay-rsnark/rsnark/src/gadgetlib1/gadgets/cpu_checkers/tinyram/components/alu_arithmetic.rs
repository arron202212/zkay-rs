...
impl<FieldT> ALU_and_gadget<FieldT> {
    ...
    pub fn new(
        ...
        not_all_zeros_result.allocate(
            &pb,
            format!("{} not_all_zeros_result", self.annotation_prefix),
        );

        pack_result=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            res_word,
            result,
            format!("{} pack_result", self.annotation_prefix),
        ));
        not_all_zeros=RcCell::new(disjunction_gadget::<FieldT>::new(
            pb,
            res_word,
...
impl ALU_add_gadget {
    pub fn new(
        ...
        unpack_addition=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            res_word_and_flag,
            addition_result,
...
impl ALU_sub_gadget<FieldT> {
    pub fn new(
        ...
        intermediate_result.allocate(
            &pb,
            format!("{} intermediate_result", self.annotation_prefix),
        );
        ...
        unpack_intermediate=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
...
impl ALU_cmp_gadget<FieldT> {
    pub fn new(
        ...
        Self {
            comparator: comparison_gadget::<FieldT>::new(
                pb,
                pb.ap.w,
                arg2val.packed,
                arg1val.packed,
...
impl ALU_cmps_gadget<FieldT> {
    pub fn new(
        ...
        negated_arg1val_sign.allocate(
            &pb,
            format!("{} negated_arg1val_sign", self.annotation_prefix),
        );
        negated_arg2val_sign.allocate(
            &pb,
        ...
        packed_modified_arg1.allocate(
            &pb,
            format!("{} packed_modified_arg1", self.annotation_prefix),
        );
        packed_modified_arg2.allocate(
            &pb,
            format!("{} packed_modified_arg2", self.annotation_prefix),
        );

        pack_modified_arg1=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            modified_arg1,
            packed_modified_arg1,
            format!("{} pack_modified_arg1", self.annotation_prefix),
        ));
        pack_modified_arg2=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            modified_arg2,
        ...
        comparator=RcCell::new(comparison_gadget::<FieldT>::new(
            pb,
            pb.ap.w,
            packed_modified_arg2,
            packed_modified_arg1,
...
impl ALU_umul_gadget<FieldT> {
    pub fn new(
        ...
        mull_bits.insert(
            mull_bits.end(),
            mul_result.bits.begin(),
            mul_result.bits.begin() + pb.ap.w,
        );
        umulh_bits.insert(
            umulh_bits.end(),
            mul_result.bits.begin() + pb.ap.w,
        ...
        pack_mull_result=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            mull_bits,
            mull_result,
            format!("{} pack_mull_result", self.annotation_prefix),
        ));
        pack_umulh_result=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            umulh_bits,
            umulh_result,
            format!("{} pack_umulh_result", self.annotation_prefix),
        ));

        result_flag.allocate(&pb, format!("{} result_flag", self.annotation_prefix));
        compute_flag=RcCell::new(disjunction_gadget::<FieldT>::new(
            pb,
            umulh_bits,
            result_flag,
            format!("{} compute_flag", self.annotation_prefix),
        ));
        // ALU_arithmetic_gadget<FieldT>(&pb, opcode_indicators, desval, arg1val, arg2val, flag, mull_result, mull_flag, annotation_prefix),
        Self {
            mul_result: dual_variable_gadget::<FieldT>::new(
                pb,
                2 * pb.ap.w,
                format!("{} mul_result", self.annotation_prefix),
            ),
            mull_result,
            mull_flag,
            umulh_result,
...
impl ALU_smul_gadget<FieldT> {
    pub fn new(
        ...
        pack_smulh_result=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            smulh_bits,
            smulh_result,
            format!("{} pack_smulh_result", self.annotation_prefix),
        ));

        top.allocate(&pb, format!("{} top", self.annotation_prefix));
        pack_top=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            pb_variable_array::<FieldT>(
                mul_result.bits.begin() + pb.ap.w - 1,
                mul_result.bits.begin() + 2 * pb.ap.w,
            ),
            top,
...
impl ALU_divmod_gadget<FieldT> {
    pub fn new(
        ...
        r_less_B=RcCell::new(comparison_gadget::<FieldT>::new(
            pb,
            pb.ap.w,
            umod_result,
            arg2val.packed,
            B_nonzero,
            ONE,
            format!("{} r_less_B", self.annotation_prefix),
        ));
...
impl ALU_shr_shl_gadget<FieldT> {
    pub fn new(
        ...
        pack_reversed_input=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            pb_variable_array::<FieldT>(arg1val.bits.rbegin(), arg1val.bits.rend()),
            reversed_input,
        ...
        barrel_right_internal.allocate(
            &pb,
            logw + 1,
            format!("{} barrel_right_internal", self.annotation_prefix),
        );
        ...
        for i in 0..logw {
            shifted_out_bits[i].allocate(
                &pb,
                1u64 << i,
                format!("{} shifted_out_bits_{}", self.annotation_prefix, i),
            );
        }

        is_oversize_shift.allocate(&pb, format!("{} is_oversize_shift", self.annotation_prefix));
        check_oversize_shift=RcCell::new(disjunction_gadget::<FieldT>::new(
            pb,
        ...
        result_bits.allocate(
            &pb,
            pb.ap.w,
            format!("{} result_bits", self.annotation_prefix),
        );
        unpack_result=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            result_bits,
            result, //barrel_right_internal[logw],
            format!("{} unpack_result", self.annotation_prefix),
        ));

        reversed_result.allocate(&pb, format!("{} reversed_result", self.annotation_prefix));
        pack_reversed_result=RcCell::new(packing_gadget::<FieldT>::new(
            pb,
            pb_variable_array::<FieldT>(result_bits.rbegin(), result_bits.rend()),
            reversed_result,
...
//
type initializer_fn<T, FieldT> = fn(
...
//
pub fn brute_force_arithmetic_gadget<T, FieldT>(
    w: usize,
    opcode: usize,
    ...
    for i in 0..1u64 << ap.opcode_width() {
        pb.borrow().val(&opcode_indicators[i]) = if i == opcode {
            FieldT::one()
        } else {
            FieldT::zero()
        }
    ...
    for des in 0..(1u32 << w) {
        pb.borrow().val(&desval.packed) = FieldT(des);
        desval.generate_r1cs_witness_from_packed();

        for f in 0..=1 {
            pb.borrow().val(&flag) = if f { FieldT::one() } else { FieldT::zero() };

            for arg1 in 0..(1u32 << w) {
                pb.borrow().val(&arg1val.packed) = FieldT(arg1);
                arg1val.generate_r1cs_witness_from_packed();

                for arg2 in 0..(1u32 << w) {
                    pb.borrow().val(&arg2val.packed) = FieldT(arg2);
                    ...
                    print!(
                        ...
                        f,
                        des,
                        ffec::from_twos_complement(des, w),
                        arg1,
                        ffec::from_twos_complement(arg1, w),
                        arg2,
                        ffec::from_twos_complement(arg2, w),
                        res,
                        ffec::from_twos_complement(res, w),
                        res_f
                    );
                    //#endif
                    ...
                    assert!(pb.borrow().val(&result) == FieldT(res));
                    assert!(
                        pb.borrow().val(&result_flag) == (if res_f { FieldT::one() } else { FieldT::zero() })
                    );
                }
            }
        }
...
impl ALU_and_gadget<FieldT> {
    ...
    pub fn generate_r1cs_witness(&self) {
        for i in 0..self.pb.ap.w {
            let b1 = self.pb.borrow().val(&self.arg1val.bits[i]) == FieldT::one();
            let b2 = self.pb.borrow().val(&self.arg2val.bits[i]) == FieldT::one();

            self.pb.borrow().val(&self.res_word[i]) = if b1 && b2 {
                FieldT::one()
            } else {
                FieldT::zero()
            }
        ...
        self.pb.borrow().val(&self.result_flag) = FieldT::one() - self.pb.borrow().val(&not_all_zeros_result);
    }
}
...
impl ALU_or_gadget<FieldT> {
    ...
    pub fn generate_r1cs_witness(&self) {
        ...
        pack_result.generate_r1cs_witness_from_bits();
        not_all_zeros.generate_r1cs_witness();
        self.pb.borrow().val(&self.result_flag) = FieldT::one() - self.pb.borrow().val(&self.not_all_zeros_result);
    }
}
pub fn test_ALU_or_gadget(w: usize) {
...
impl ALU_not_gadget<FieldT> {
    ...
    pub fn generate_r1cs_witness(&self) {
        for i in 0..self.pb.ap.w {
            ...
            self.pb.borrow().val(&self.res_word[i]) = if !b2 { FieldT::one() } else { FieldT::zero() }
        }
...
pub fn test_ALU_not_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_not_gadge<FieldT>, FieldT>(
        w,
        tinyram_opcode_NOT,
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         opcode_indicators: &pb_variable_array<FieldT, tinyram_protoboard<FieldT>>,
...
impl ALU_add_gadget<FieldT> {
    ...
    pub fn generate_r1cs_witness(&self) {
        self.pb.borrow().val(&addition_result) =
            self.pb.borrow().val(&self.arg1val.packed) + self.pb.borrow().val(&self.arg2val.packed);
...
impl ALU_sub_gadget<FieldT> {
    ...
    pub fn generate_r1cs_witness(&self) {
        ...
        self.pb.borrow().val(&intermediate_result) =
            twoi + self.pb.borrow().val(&self.arg1val.packed) - self.pb.borrow().val(&self.arg2val.packed);
        unpack_intermediate.generate_r1cs_witness_from_packed();
        pack_result.generate_r1cs_witness_from_bits();
        self.pb.borrow().val(&self.result_flag) = FieldT::one() - self.pb.borrow().val(&self.negated_flag);
    }
}
...
impl ALU_mov_gadget<FieldT> {
    pub fn generate_r1cs_constraints(&self) {
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.arg2val.packed], vec![self.result]),
            format!("{} mov_result", self.annotation_prefix),
        );

        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.flag], vec![self.result_flag]),
            format!("{} mov_result_flag", self.annotation_prefix),
        );
    }

    pub fn generate_r1cs_witness(&self) {
        self.pb.borrow().val(&self.result) = self.pb.borrow().val(&self.arg2val.packed);
        self.pb.borrow().val(&self.result_flag) = self.pb.borrow().val(&self.flag);
    }
}
...
impl ALU_cmov_gadget<FieldT> {
    ...
    pub fn generate_r1cs_witness(&self) {
        self.pb.borrow().val(&self.result) = (if (self.pb.borrow().val(&self.flag) == FieldT::one()) {
            self.pb.borrow().val(&self.arg2val.packed)
        } else {
            self.pb.borrow().val(&self.desval.packed)
        });
        self.pb.borrow().val(&self.result_flag) = self.pb.borrow().val(&self.flag);
    }
}
...
impl ALU_cmp_gadget<FieldT> {
    pub fn generate_r1cs_constraints(&self) {
        ...
        */
        ...
        /* copy over results */
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.desval.packed], vec![cmpe_result]),
            format!("{} cmpe_result", self.annotation_prefix),
        );

        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.desval.packed], vec![cmpa_result]),
            format!("{} cmpa_result", self.annotation_prefix),
        );

        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.desval.packed], vec![cmpae_result]),
    ...
    pub fn generate_r1cs_witness(&self) {
        ...
        self.pb.borrow().val(&cmpe_result) = self.pb.borrow().val(&self.desval.packed);
        self.pb.borrow().val(&cmpa_result) = self.pb.borrow().val(&self.desval.packed);
        self.pb.borrow().val(&cmpae_result) = self.pb.borrow().val(&self.desval.packed);

        self.pb.borrow().val(&cmpe_result_flag) = (if (self.pb.borrow().val(&cmpae_result_flag) == FieldT::one())
            && (self.pb.borrow().val(&cmpa_result_flag) == FieldT::zero())
        {
            FieldT::one()
        } else {
            FieldT::zero()
    ...
    brute_force_arithmetic_gadget::<ALU_cmp_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         -> ALU_cmp_gadget<FieldT> {
            let mut cmpa_result = variable::<FieldT, pb_variable>::new();
            cmpa_result.allocate(&pb, "cmpa_result");
            let mut cmpa_result_flag = variable::<FieldT, pb_variable>::new();
            cmpa_result_flag.allocate(&pb, "cmpa_result_flag");
            let mut cmpae_result = variable::<FieldT, pb_variable>::new();
            cmpae_result.allocate(&pb, "cmpae_result");
            let mut cmpae_result_flag = variable::<FieldT, pb_variable>::new();
...
pub fn test_ALU_cmpa_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_cmp_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         result_flag: &variable<FieldT,pb_variable>|
         -> ALU_cmp_gadget<FieldT> {
            let mut cmpe_result = variable::<FieldT, pb_variable>::new();
            cmpe_result.allocate(&pb, "cmpe_result");
            let mut cmpe_result_flag = variable::<FieldT, pb_variable>::new();
...
impl ALU_cmps_gadget<FieldT> {
    pub fn generate_r1cs_constraints(&self) {
        ...
        /* copy over results */
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.desval.packed], vec![cmpg_result]),
            format!("{} cmpg_result", self.annotation_prefix),
        );

        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.desval.packed], vec![cmpge_result]),
    ...
    pub fn generate_r1cs_witness(&self) {
        /* negate sign bits */
        self.pb.borrow().val(&negated_arg1val_sign) =
            FieldT::one() - self.pb.borrow().val(&self.arg1val.bits[self.pb.ap.w - 1]);
        self.pb.borrow().val(&negated_arg2val_sign) =
            FieldT::one() - self.pb.borrow().val(&self.arg2val.bits[self.pb.ap.w - 1]);
        ...
        self.pb.borrow().val(&cmpg_result) = self.pb.borrow().val(&self.desval.packed);
        self.pb.borrow().val(&cmpge_result) = self.pb.borrow().val(&self.desval.packed);
    }
}
pub fn test_ALU_cmpg_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_cmps_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         -> ALU_cmps_gadget<FieldT> {
            let mut cmpge_result = variable::<FieldT, pb_variable>::new();
            cmpge_result.allocate(&pb, "cmpge_result");
            let mut cmpge_result_flag = variable::<FieldT, pb_variable>::new();
        ...
        |des: usize, f: bool, x: usize, y: usize| -> bool {
            return (ffec::from_twos_complement(x, w) > ffec::from_twos_complement(y, w));
        },
    );
...
pub fn test_ALU_cmpge_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_cmps_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         result_flag: &variable<FieldT,pb_variable>|
         -> ALU_cmps_gadget<FieldT> {
            let mut cmpg_result = variable::<FieldT, pb_variable>::new();
            cmpg_result.allocate(&pb, "cmpg_result");
            let mut cmpg_result_flag = variable::<FieldT, pb_variable>::new();
...
impl ALU_umul_gadget<FieldT> {
    pub fn generate_r1cs_constraints(&self) {
        ...
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.result_flag], vec![mull_flag]),
            format!("{} mull_flag", self.annotation_prefix),
        );

        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.result_flag], vec![umulh_flag]),
    ...
    pub fn generate_r1cs_witness(&self) {
        /* do multiplication */
        self.pb.borrow().val(&mul_result.packed) =
            self.pb.borrow().val(&self.arg1val.packed) * self.pb.borrow().val(&self.arg2val.packed);
        ...
        self.pb.borrow().val(&mull_flag) = self.pb.borrow().val(&self.result_flag);
        self.pb.borrow().val(&umulh_flag) = self.pb.borrow().val(&self.result_flag);
    }
}
pub fn test_ALU_mull_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_umul_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         -> ALU_umul_gadget<FieldT> {
            let mut umulh_result = variable::<FieldT, pb_variable>::new();
            umulh_result.allocate(&pb, "umulh_result");
            let mut umulh_flag = variable::<FieldT, pb_variable>::new();
...
pub fn test_ALU_umulh_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_umul_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         result_flag: &variable<FieldT,pb_variable>|
         -> ALU_umul_gadget<FieldT> {
            let mut mull_result = variable::<FieldT, pb_variable>::new();
            mull_result.allocate(&pb, "mull_result");
            let mut mull_flag = variable::<FieldT, pb_variable>::new();
...
impl ALU_smul_gadget<FieldT> {
    pub fn generate_r1cs_constraints(&self) {
        ...
        */
        ...
        a.add_term(
            ...
            -(FieldT(2) ^ self.pb.ap.w),
        );
        b.add_term(self.arg2val.packed, 1);
        b.add_term(
            self.arg2val.bits[self.pb.ap.w - 1],
            -(FieldT(2) ^ self.pb.ap.w),
        );
        ...
        */
        ...
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![is_top_empty], vec![top], vec![ONE * 0]),
    ...
    pub fn generate_r1cs_witness(&self) {
        ...
        */
        self.pb.borrow().val(&mul_result.packed) = (self.pb.borrow().val(&self.arg1val.packed)
            - (self.pb.borrow().val(&self.arg1val.bits[self.pb.ap.w - 1]) * (FieldT(2) ^ self.pb.ap.w)))
            * (self.pb.borrow().val(&self.arg2val.packed)
                - (self.pb.borrow().val(&self.arg2val.bits[self.pb.ap.w - 1]) * (FieldT(2) ^ self.pb.ap.w)))
        ...
        let topval = self.pb.borrow().val(&top).as_ulong();

        if topval == 0 {
            self.pb.borrow().val(&is_top_empty) = FieldT::one();
            self.pb.borrow().val(&is_top_empty_aux) = FieldT::zero();
        } else {
            self.pb.borrow().val(&is_top_empty) = FieldT::zero();
            self.pb.borrow().val(&is_top_empty_aux) = self.pb.borrow().val(&top).inverse();
        }

        if topval == ((1u64 << (self.pb.ap.w + 1)) - 1) {
            self.pb.borrow().val(&is_top_full) = FieldT::one();
            self.pb.borrow().val(&is_top_full_aux) = FieldT::zero();
        } else {
            self.pb.borrow().val(&is_top_full) = FieldT::zero();
            self.pb.borrow().val(&is_top_full_aux) =
                (self.pb.borrow().val(&top) - FieldT((1u64 << (self.pb.ap.w + 1)) - 1)).inverse();
        }

        /* smulh_flag = 1 - (is_top_full + is_top_empty) */
        self.pb.borrow().val(&smulh_flag) =
            FieldT::one() - (self.pb.borrow().val(&is_top_full) + self.pb.borrow().val(&is_top_empty));
    }
}
pub fn test_ALU_smulh_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_smul_gadget<FieldT>, FieldT>(
        ...
        |des: usize, f: bool, x: usize, y: usize| -> usize {
            let res = ffec::to_twos_complement(
                (ffec::from_twos_complement(x, w) * ffec::from_twos_complement(y, w)),
                2 * w,
            );
            return res >> w;
        },
        |des: usize, f: bool, x: usize, y: usize| -> bool {
            ...
            let truncated_res = ffec::from_twos_complement(
                ffec::to_twos_complement(res, 2 * w) & ((1u64 << w) - 1),
                w,
            );
...
impl ALU_divmod_gadget<FieldT> {
    ...
    pub fn generate_r1cs_witness(&self) {
        if self.pb.borrow().val(&self.arg2val.packed) == FieldT::zero() {
            self.pb.borrow().val(&B_inv) = FieldT::zero();
            self.pb.borrow().val(&B_nonzero) = FieldT::zero();

            self.pb.borrow().val(&A_aux) = FieldT::zero();

            self.pb.borrow().val(&udiv_result) = FieldT::zero();
            self.pb.borrow().val(&umod_result) = FieldT::zero();

            self.pb.borrow().val(&udiv_flag) = FieldT::one();
            self.pb.borrow().val(&umod_flag) = FieldT::one();
        } else {
            self.pb.borrow().val(&B_inv) = self.pb.borrow().val(&self.arg2val.packed).inverse();
            self.pb.borrow().val(&B_nonzero) = FieldT::one();

            let A = self.pb.borrow().val(&self.arg1val.packed).as_ulong();
            let B = self.pb.borrow().val(&self.arg2val.packed).as_ulong();

            self.pb.borrow().val(&A_aux) = self.pb.borrow().val(&self.arg1val.packed);

            self.pb.borrow().val(&udiv_result) = FieldT(A / B);
            self.pb.borrow().val(&umod_result) = FieldT(A % B);

            self.pb.borrow().val(&udiv_flag) = FieldT::zero();
            self.pb.borrow().val(&umod_flag) = FieldT::zero();
        }
    ...
    brute_force_arithmetic_gadget::<ALU_divmod_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         -> ALU_divmod_gadget<FieldT> {
            let mut umod_result = variable::<FieldT, pb_variable>::new();
            umod_result.allocate(&pb, "umod_result");
            let mut umod_flag = variable::<FieldT, pb_variable>::new();
...
pub fn test_ALU_umod_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_divmod_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         result_flag: &variable<FieldT,pb_variable>|
         -> ALU_divmod_gadget<FieldT> {
            let mut udiv_result = variable::<FieldT, pb_variable>::new();
            udiv_result.allocate(&pb, "udiv_result");
            let mut udiv_flag = variable::<FieldT, pb_variable>::new();
...
impl ALU_shr_shl_gadget<FieldT> {
    pub fn generate_r1cs_constraints(&self) {
        ...
        */
        ...
        self.pb.borrow_mut().add_r1cs_constraint(
            r1cs_constraint::<FieldT>(vec![ONE], vec![self.arg1val.bits[0]], vec![shr_flag]),
    ...
    pub fn generate_r1cs_witness(&self) {
        ...
        self.pb.borrow().val(&barrel_right_internal[0]) =
            (if self.pb.borrow().val(&self.opcode_indicators[tinyram_opcode_SHR]) == FieldT::one() {
                self.pb.borrow().val(&self.arg1val.packed)
            } else {
                self.pb.borrow().val(&reversed_input)
            });
        ...
        */
        ...
        for i in 0..logw {
            self.pb.borrow().val(&barrel_right_internal[i + 1]) =
                if (self.pb.borrow().val(&self.arg2val.bits[i]) == FieldT::zero()) {
                    self.pb.borrow().val(&barrel_right_internal[i])
                } else {
                    FieldT(self.pb.borrow().val(&barrel_right_internal[i]).as_ulong() >> (i + 1))
                };

            shifted_out_bits[i].fill_with_bits_of_ulong(
                self.pb,
                self.pb.borrow().val(&barrel_right_internal[i]).as_ulong() % (2u << i),
            );
        }
        ...
        */
        ...
        self.pb.borrow().val(&self.result) = (FieldT::one() - self.pb.borrow().val(&is_oversize_shift))
            * self.pb.borrow().val(&barrel_right_internal[logw]);
        ...
        */
        ...
        /*
          ...
          r - reverse(result) = (result - reverse(result)) * opcode_indicators[SHR]
        */
        self.pb.borrow().val(&shr_result) =
            if (self.pb.borrow().val(&self.opcode_indicators[tinyram_opcode_SHR]) == FieldT::one()) {
                self.pb.borrow().val(&self.result)
            } else {
                self.pb.borrow().val(&reversed_result)
            };

        self.pb.borrow().val(&shl_result) = self.pb.borrow().val(&shr_result);
        self.pb.borrow().val(&shr_flag) = self.pb.borrow().val(&self.arg1val.bits[0]);
        self.pb.borrow().val(&shl_flag) = self.pb.borrow().val(&self.arg1val.bits[self.pb.ap.w - 1]);
    }
}
pub fn test_ALU_shr_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_shr_shl_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         -> ALU_shr_shl_gadget<FieldT> {
            let mut shl_result = variable::<FieldT, pb_variable>::new();
            shl_result.allocate(&pb, "shl_result");
            let mut shl_flag = variable::<FieldT, pb_variable>::new();
...
pub fn test_ALU_shl_gadget(w: usize) {
    ...
    brute_force_arithmetic_gadget::<ALU_shr_shl_gadget<FieldT>, FieldT>(
        ...
        |pb: RcCell<protoboard<FieldT, tinyram_protoboard<FieldT>>>,
         ...
         result_flag: &variable<FieldT,pb_variable>|
         -> ALU_shr_shl_gadget<FieldT> {
            let mut shr_result = variable::<FieldT, pb_variable>::new();
            shr_result.allocate(&pb, "shr_result");
            let mut shr_flag = variable::<FieldT, pb_variable>::new();
