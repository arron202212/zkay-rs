    ...
    next_has_accepted(next_has_accepted)
{
    ...
    */
    ...
    pack_ls_prev_val.reset(new packing_gadget<FieldT>(self.pb, ls_prev_val, packed_ls_prev_val, FMT(annotation_prefix, " pack_ls_prev_val")));
    packed_ls_next_val.allocate(pb, FMT(annotation_prefix, " packed_ls_next_val"));
    pack_ls_next_val.reset(new packing_gadget<FieldT>(self.pb, ls_next_val, packed_ls_next_val, FMT(annotation_prefix, " pack_ls_next_val")));
...
void fooram_cpu_checker<FieldT>::generate_r1cs_constraints()
{
    ...
    */
    ...
    self.pb.add_r1cs_constraint(r1cs_constraint<FieldT>(prev_pc_val[0],
                                 ...
                                 FMT(self.annotation_prefix, " compute_ls_addr_packed"));
    ...
    */
    ...
    self.pb.add_r1cs_constraint(r1cs_constraint<FieldT>(prev_pc_val[0],
                                 ...
                                 FMT(self.annotation_prefix, " compute_packed_ls_next_val"));
    ...
    */
    ...
    self.pb.add_r1cs_constraint(r1cs_constraint<FieldT>(prev_pc_val[0],
                                 ...
                                 FMT(self.annotation_prefix, " compute_packed_next_state"));

    /* next_has_accepted = 1 */
    self.pb.add_r1cs_constraint(r1cs_constraint<FieldT>(1, next_has_accepted, 1), FMT(self.annotation_prefix, " always_accepted"));
}
